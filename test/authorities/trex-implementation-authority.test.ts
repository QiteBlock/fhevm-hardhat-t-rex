  ...
  describe(".setTREXFactory()", () => {
    describe("When not called by the owner", () => {
      it("Should revert", async () => {
        ...
        await expect(trexImplementationAuthority.connect(signers.anotherWallet).setTREXFactory(ZERO_ADDRESS)).to.be
          .reverted;
      });
    });
  ...
  describe(".setIAFactory()", () => {
    describe("When not called by the owner", () => {
      it("Should revert", async () => {
        ...
        await expect(trexImplementationAuthority.connect(signers.anotherWallet).setIAFactory(ZERO_ADDRESS)).to.be
          .reverted;
      });
    });
  ...
  describe(".addTREXVersion()", () => {
    describe("when called not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          trexImplementationAuthority.connect(signers.anotherWallet).addTREXVersion(versionStruct, contractsStruct)
        ).to.be.reverted;
      });
    });
  ...
  describe(".useTREXVersion()", () => {
    describe("when called not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(trexImplementationAuthority.connect(signers.anotherWallet).useTREXVersion(versionStruct)).to.be
          .reverted;
      });
    });
      ...
      describe("when called on a reference authority contract", () => {
        ...
        describe("when caller is owner of every contract of the suite of the token", () => {
          it("should deploy a new authority contract", async () => {
            ...
            const tx = await trexImplementationAuthority.changeImplementationAuthority(
