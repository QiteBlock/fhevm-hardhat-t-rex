  ...
  describe(".setMaxBalance", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(context.suite.complianceModule.setMaxBalance(100)).to.revertedWith(
  ...
  describe(".moduleMintAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(context.suite.complianceModule.moduleMintAction(from, 10)).to.revertedWith(
          "only bound compliance can call"
        );
      });
    });
  ...
  describe(".moduleBurnAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(context.suite.complianceModule.moduleBurnAction(from, 10)).to.revertedWith(
          "only bound compliance can call"
        );
      });
    });
