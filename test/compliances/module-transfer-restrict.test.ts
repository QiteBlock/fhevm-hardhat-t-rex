  ...
  describe(".allowUser", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.allowUser(context.accounts.signers.aliceWallet.address)
  ...
  describe(".disallowUser", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.disallowUser(context.accounts.signers.aliceWallet.address)
        ).to.revertedWith("only bound compliance can call");
      });
    });
