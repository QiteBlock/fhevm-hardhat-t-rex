...
interface ITREXGateway {
     ...
     * @dev Enables or disables public deployments. If the function call doesn't change the
     * current status, it will revert.
     ...
     * @dev Enables or disables the deployment fees. If the function call doesn't change
     * the current status, it will revert.
     ...
     * The function will revert if the length of the `deployers` array is more than 500 to prevent
     ...
     * If the discount exceeds 10000, the function will revert. Emits a `FeeDiscountApplied`
     ...
     * The function will revert if the length of the `deployers` array exceeds 500, to prevent
     * excessive gas consumption.
