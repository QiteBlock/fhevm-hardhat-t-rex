...
abstract contract SupplyLimit is BasicCompliance {
     ...
     */
    function setSupplyLimit(uint64 _limit) external onlyOwner {
        supplyLimit = _limit;
    ...
    function _transferActionOnSupplyLimit(address _from, address _to, euint64 _value) internal {}
     ...
     */
    // solhint-disable-next-line no-empty-blocks
    function _destructionActionOnSupplyLimit(address _from, euint64 _value) internal {}
}
