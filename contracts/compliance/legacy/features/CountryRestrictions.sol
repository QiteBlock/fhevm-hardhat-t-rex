...
abstract contract CountryRestrictions is BasicCompliance {
    ...
    function _transferActionOnCountryRestrictions(address _from, address _to, euint64 _value) internal {}
     ...
     */
    // solhint-disable-next-line no-empty-blocks
    function _creationActionOnCountryRestrictions(address _to, uint64 _value) internal {}
     ...
     */
    // solhint-disable-next-line no-empty-blocks
    function _destructionActionOnCountryRestrictions(address _from, euint64 _value) internal {}
}
