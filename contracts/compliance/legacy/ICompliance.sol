...
interface ICompliance {
     ...
     */
    function transferred(address _from, address _to, euint64 _amount) external returns (ebool);
     ...
     *  @param _amount The amount of tokens involved in the transfer
     */
    function created(address _to, euint64 _amount) external returns (ebool);
     ...
     *  @param _amount The amount of tokens involved in the transfer
     */
    function destroyed(address _from, euint64 _amount) external;
     ...
     *  @param _amount The amount of tokens involved in the transfer
     */
    function canTransfer(address _from, address _to, euint64 _amount) external returns (ebool);
}
