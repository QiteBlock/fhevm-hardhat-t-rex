...
contract MaxBalanceModule is AbstractModuleUpgradeable {
     ...
     */
    function preSetModuleState(address _compliance, address _id, einput _encryptedAmount, bytes calldata _inputProof) public {
    ...
    function moduleTransferAction(
        ...
        // If the current balance plus the value to transfer is exceeding the max balance defined then
    ...
    function moduleCheck(address /*_from*/, address _to, euint64 _value, address _compliance) external override returns (ebool) {
        ...
        // If the current balance plus the value to transfer is exceeding the max balance defined
        // then it should not transfer
