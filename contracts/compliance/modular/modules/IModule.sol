...
interface IModule {
     ...
     *  @param _value amount of tokens sent encrypted
     */
    function moduleTransferAction(address _from, address _to, euint64 _value) external returns (ebool);
     ...
     *  @param _value amount of tokens minted encrypted
     */
    function moduleMintAction(address _to, euint64 _value) external returns (ebool);
     ...
     *  @param _value amount of tokens burnt encrypted
     */
    function moduleBurnAction(address _from, euint64 _value) external;
     ...
     */
    function moduleCheck(address _from, address _to, euint64 _value, address _compliance) external returns (ebool);
